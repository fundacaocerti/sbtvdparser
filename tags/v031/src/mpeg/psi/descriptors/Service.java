...
public class Service extends Descriptor {
	...
	final String[] typeNames = { "Reservado para uso futuro", "Televisão digital", "Áudio digital", "Teletexto",
			"Referência NVOD", "Serv. time-shifted NVOD", "Mosaico", "Cod. avançada de rádio digital",
			"Cod. avançada de mosaico", "Transmissão de dados", "Reservado para interface de uso comum (ver EN 50221)",
			"RCS Map (ver EN 301790)", "RCS FLS (ver EN 301790)", "Serv. DVB MHP", "Televisão digital MPEG-2",
			"Cod. avançada de televisão digital SD", "Cod. avançada de NVOD SD time-shifted",
			"Cod. avançada de referência NVOD SD", "Cod. avançada de televisão digital HD",
			"Cod. avançada de NVOD HD time-shifted", "Cod. avançada de referência NVOD HD", "Serv. especial de vídeo",
			"Serv. especial de áudio", "Serv. especial de dados", "Engenharia (atualização de software)",
			"Serv. promocional de vídeo", "Serv. promocional de áudio", "Serv. promocional de dados",
			"Dados para armazenamento antecipado", "Dados exclusivo para armazenamento", "Lista de Serv.s de bookmark",
